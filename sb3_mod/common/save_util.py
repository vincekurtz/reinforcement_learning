...
import sb3_mod as sb3
from sb3_mod.common.type_aliases import TensorDict
from sb3_mod.common.utils import get_device, get_system_info
...
def save_to_zip_file(
    ...
    with zipfile.ZipFile(save_path, mode="w") as archive:
        ...
        archive.writestr("_sb3_mod_version", sb3.__version__)
